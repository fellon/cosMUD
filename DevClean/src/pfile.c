...
void	fread_pfile		args( ( FILE *fp, time_t tdiff, char *fname, bool count ) );
void	read_pfile		args( ( char *dirname, char *filename, bool count ) );
void	pfile_scan		args( ( bool count ) );
