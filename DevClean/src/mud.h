...
#include <stdlib.h>
#include <limits.h>
/* #include "dmalloc/include/dmalloc.h" */ /* Define if using debugger */
...
typedef struct  locker_data		LOCKER_DATA;    /* Shadowlands Locker Code */
...
#define MAX_CLASS           	  32 /* Was 24. More added by Fellon */
#define MAX_NPC_CLASS		   34 /* Max_class + 2 */
#define MAX_RACE                   54 /* (was 45) more 5/24/02 Fellon */
#define MAX_NPC_RACE		   103 /* added 12 more */
#define	MAX_SPECIES	 	   12	/* species snip - 5/28/02 */
#define MAX_LEVEL		   116
#define MAX_CLAN		   100
#define MAX_DEITY		   100
...
typedef enum {
  ...
  RACE_GARGOYLE, RACE_DEMON
} race_types;

/* npc races */
/* #define	RACE_DRAGON	    31 */
/* #define	RACE_DEMON	45 */
...
#define OBJ_VNUM_DEITY               43

/* Im not even close to being done with this all these have to be made.
these defines are for a more intelligent definition of part_vnums[] in 
fight.c 
*/

#define OBJ_VNUM_BRAINS              75
#define OBJ_VNUM_HANDS               76
#define OBJ_VNUM_FEET                77
#define OBJ_VNUM_FINGERS             78
#define OBJ_VNUM_EAR                 79
#define OBJ_VNUM_EYE                 80
#define OBJ_VNUM_LONG_TONGUE         81
#define OBJ_VNUM_EYESTALKS           82
#define OBJ_VNUM_TENTACLES           83
#define OBJ_VNUM_FINS                84
#define OBJ_VNUM_WINGS               85
#define OBJ_VNUM_TAIL                86
#define OBJ_VNUM_SCALES              87
#define OBJ_VNUM_TUSKS               88
#define OBJ_VNUM_HORNS               89
#define OBJ_VNUM_CLAWS               90
#define OBJ_VNUM_FEATHERS            91
#define OBJ_VNUM_FORELEGS            92
#define OBJ_VNUM_PAWS                93
#define OBJ_VNUM_HOOVES              94
#define OBJ_VNUM_BEAK                95
#define OBJ_VNUM_SHARPSCALES         96
#define OBJ_VNUM_HAUNCHES            97
#define OBJ_VNUM_FANGS               98
...
struct	char_data
{
    ...
    char *		long_descr;
    char *		description;
    sh_int              ghost_level; /* Froboz */
    sh_int              incog_level; /* Froboz */
    sh_int		num_fighting;
    sh_int		substate;
    sh_int		sex;
    sh_int		class;
...
struct	pc_data
{
	...
	int memorize[7]; /* Locations that can be memorized with the memorize command -- Scion */
#ifdef I3
    char		i3_replyname[MIL]; /* Target for reply - Samson 1-23-01 */
...
struct	system_data
{
    ...
    sh_int	staff_level;		/* Level of staff channel */
...
extern  sh_int  gsn_fourth_cast;
extern  sh_int  gsn_fifth_cast;
extern  sh_int  gsn_sixth_cast;
extern  sh_int  gsn_seventh_cast;
extern  sh_int  gsn_eighth_cast;
...
/* At Ntanel's request, Samson changed these back to the normal versions.
 * 5-4-01
 */
...
#define WAIT_STATE(ch, npulse) ((ch)->wait=(!IS_NPC(ch)&&ch->pcdata->nuisance&&\
			      ...
			      IS_IMMORTAL(ch)?0: UMAX((ch)->wait, (npulse)))
/* Immortal check by Prage, might be buggy 1 could be better than 0 */
...
DECLARE_DO_FUN( do_ax_export	);
DECLARE_DO_FUN( do_ax_import	);
...
DECLARE_DO_FUN( do_invade	); /* Fellon */
...
DECLARE_DO_FUN( do_races	); /* Fellon */
...
#define CRASHSAFE	"../src/crashsafe/rmexe"
/*
...
/* cronel all pkill mode */
/* hskelter.c (addit.c) */
void register_hskelter_pkill args( (CHAR_DATA*ch) );
