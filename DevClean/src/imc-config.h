/* $Id: imc-config.h,v 1.12 2000/02/12 01:18:23 gmoody Exp $ */
/*
...
/* I had to put this somewhere. Used in imc.c and imc-interp.c so far.-- Kratas */
#ifndef TRUE
#define TRUE 1
#endif
#ifndef FALSE
...
#define VERSION_ID "imc2-2.00g "

/* Incase of hubs, need to have this set */
#ifdef MUD_TITLE
#define IMC_VERSIONID VERSION_ID MUD_TITLE
#else
#define IMC_VERSIONID VERSION_ID "hub"
#endif
