...
void do_sell( CHAR_DATA *ch, char *argument )
{
	...
	if ( IS_OBJ_STAT( obj, ITEM_ARTIFACT )) {
		send_to_char( "Sell such a powerful artifact!?  You must be kidding!\r\n", ch);
		return;
	}
...
void do_value( CHAR_DATA *ch, char *argument )
{
	...
	if (IS_OBJ_STAT(obj, ITEM_ARTIFACT)) {
		act( AT_TELL, "$n tells you 'I cannot concieve of buying such a powerful object!'", keeper, obj,ch,TO_VICT);
	}
