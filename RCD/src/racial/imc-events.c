/* $Id: imc-events.c,v 1.9 2000/02/27 12:12:20 gmoody Exp $ */
/*
...
/* changed this for 2.00 i think it was wrong along - shogar - 1/25/2000 */
/*
...
{
  imc_cancel_event(ev_close_notify, data);
  imc_close_notify(data);
}
