/* $Id: icec.h,v 1.4 2000/02/03 13:56:21 gmoody Exp $ */
/*
...
void icec_recv_msg_comp_r( const char *from, const char *realfrom, const char *chan, int length, const char *txt, int emote);
void icec_recv_msg_b(const char *from, const char *chan, const char *txt, int emote);
void icec_recv_msg_comp_b(const char *from, const char *chan, int length, const char *txt, int emote);
