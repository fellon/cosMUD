/* $Id: iced.h,v 1.4 2000/02/03 13:56:22 gmoody Exp $ */
/*
...
#define ICED_CREATORS "shogar@drgnbane ntanel@ucmm shogar@ucode ntanel@ucode scion@ucmm scion@apn kratas@ucmm kratas@eternal"

/* refresh timeout */
#define ICED_REFRESH_TIME 30
...
void iced_recv_msg_comp_p(const char *from, const char *chan, int length, const char *txt, int emote);
