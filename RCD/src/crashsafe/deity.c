...
void do_setdeity( CHAR_DATA *ch, char *argument )
{
	...
	send_to_char( "scorpse savatar sdeityobj srecall suplift\n\r\n\r", ch );
...
void do_showdeity( CHAR_DATA *ch, char *argument )
{
	...
	deity->sdeityobj, deity->srecall, deity->suplift );
    return;
}
...
void do_supplicate( CHAR_DATA *ch, char *argument )
{
	...
	for ( obj = first_object; obj; obj = obj->next )
	{
	   ...
	   {
		found = TRUE;
		if ( IS_SET( obj->in_room->room_flags, ROOM_NOSUPPLICATE ) || (obj->timer > 35) )
		{
