...
DO_FUN *skill_function( char *name )
{
	...
	if ( !str_cmp( name, "do_hometowns" ))		return do_hometowns;
...
/*	if ( !str_cmp( name, "do_mapout" ))		return do_mapout; */
	...
	if ( !str_cmp( name, "do_mphtownset" ))		return do_mphtownset;
...
/* Scion arenacode */
    ...
    if ( skill == do_hometowns )	return "do_hometowns";
...
/*    if ( skill == do_mapout )		return "do_mapout"; */
    ...
    if ( skill == do_mphtownset	)	return "do_mphtownset";
