...
const   struct  race_type       _race_table      [MAX_RACE]      =
{
    ...
    {
	"Elf",	 {{1 << AFF_DETECT_MAGIC,0,0,0}},     -1, 2, 0, 1,-1, 1, 0, -2,10, 0, 0,	0,										    LANG_ELVEN
    },

    {
	"Dwarf",     {{1 << AFF_INFRARED,0,0,0}},	1, 0, 1, 0, 2,-1, 0, 6,-6, 0, 0,	(1 << CLASS_MAGE) | (1 << 8),								    LANG_DWARVEN
    },

    {
	"Halfling",     {{1<<AFF_SNEAK,0,0,0}},     -2, 1, 0, 0, 1, 0, 0, -3,10, 0, 0,	(1 << CLASS_MAGE) | (1 << CLASS_DRUID) | (1 << CLASS_CLERIC) | (1 << CLASS_AUGURER) | (1 << 8),			    LANG_HALFLING
    },
...
"kobold", "nymph", "troglodyte", "gargoyle", "Immortal", "Green", "Black",
"White",
"Blue", "Red", "Gold", "Silver", "Bronze", "Copper", "golem",
...
"augurer", "paladin", "dragon", "demon", "werewolf", "illusionist", "necromancer",
"assassin", "warlock", "battlemage", "knight", "anti-paladin", "harper",
"monk", "rogue", "angel", "psionicist", "king", "queen"
};
