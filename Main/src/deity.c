...
void do_setdeity( CHAR_DATA *ch, char *argument )
{
	...
	send_to_char( "Deityobj - vnum for sobject Avatar - vnum for savatar\n\r", ch );
...
void do_showdeity( CHAR_DATA *ch, char *argument )
{
	...
	ch_printf( ch, "Deityobj: %-8dObjstat: %-9dAvatar: %-10dWorshippers: %d\n\r",                                 /* add deityobj to showdeity */
		deity->deityobj, deity->objstat, deity->avatar, deity->worshippers );
