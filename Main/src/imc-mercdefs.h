/* $Id: imc-mercdefs.h,v 1.11 2000/02/03 13:56:31 gmoody Exp $ */
/*
...
/*
 * Uncomment this if you want to log rwhos.
 *
 * *****WARNING*****
 * This could open you up to attacks, it is not recommended you use this
 * unless your really paranoid about who's doing what over imc.
 */

/* #define I_WANT_RWHO_LOGGING */

#include "imc-mercs.h"
#include "imc-color.h"

#if !defined(ROM) && !defined(MERC) && !defined(ENVY) && !defined(SMAUG) && !defined(ACK) && !defined(CIRCLE) && !defined(HUB)
#error You must #define one of ROM, ROT, MERC, SMAUG, ENVY, ACK ,CIRCLE or HUB
#endif
...
#define IS_QUIET(ch)  (0)
#define IS_WIZINVIS(ch) (GET_INVIS_LEN(ch))
...
#ifdef SMAUG
#define IMC_GET_LEVEL(ch) (get_trust(ch))
#else
